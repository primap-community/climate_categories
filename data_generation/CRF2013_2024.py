...
OUTPATH = pathlib.Path("./climate_categories/data/CRF2013_2024.yaml")
...
def main():
    ...
    # Metadata
    spec["name"] = "CRF2013_2024"
    spec["title"] = (
        "Common Reporting Format GHG emissions categories (2013). "
        "Extended for 2024 CRF submissions."
    )
    spec["comment"] = (
    ...
    spec["institution"] = "UN"
    spec["last_update"] = "2024-07-08"
    spec["version"] = "2013-2024"
    spec["total_sum"] = True
    ...
    # for AUT name is "Airport ground activities"
    ncats["1.A.3.e.ii.3"] = {"title": "Other non-specified"}  # BEL
    # for ROU name is "Other (please specify)"
    ...
    # for CZE name is "i. Mobile (aviation component)"
    ...
    ncats["1.B.1.c.v"] = {"title": "Other"}  # ROU, new in 2022
    ...
    ncats["5.E.8"] = {"title": "Industrial Wastewater"}  # CAN # new in 2022
    ...
    ncats["5.B.2.b.xiv"] = {"title": "Waste water"}  # NOR, new in 2022
