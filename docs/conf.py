#!/usr/bin/env python
#
# climate_categories documentation build configuration file, created by
...
version = climate_categories.__version__
...
man_pages = [
    (master_doc, "climate_categories", "Climate Categories Documentation", [author], 1)
]
...
texinfo_documents = [
    (
        ...
        author,
        "climate_categories",
        "Commonly used categories for climate policy analysis.",
        "Miscellaneous",
    ),
]
