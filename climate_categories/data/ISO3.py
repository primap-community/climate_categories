...
spec = {
    ...
    "references": "ISO 3166, https://www.iso.org/iso-3166-country-codes.html; iso-codes package, https://salsa.debian.org/iso-codes-team/iso-codes; UNFCCC Parties & Observers, https://unfccc.int/parties-observers; EU members, https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:EU_enlargements ",
    "institution": "UN",
    "hierarchical": True,
    ...
    "categories": {
        ...
        "AFG": {
            ...
            "info": {"official name": "Islamic Republic of Afghanistan"},
        },
        "AGO": {
            "title": "Angola",
            "alternative_codes": ["AO", "024"],
            "info": {"official name": "Republic of Angola"},
        },
        ...
        "ALB": {
            ...
            "info": {"official name": "Republic of Albania"},
        },
        "AND": {
            "title": "Andorra",
            "alternative_codes": ["AD", "020"],
            "info": {"official name": "Principality of Andorra"},
        },
        "ARE": {"title": "United Arab Emirates", "alternative_codes": ["AE", "784"]},
        "ARG": {
            "title": "Argentina",
            "alternative_codes": ["AR", "032"],
            "info": {"official name": "Argentine Republic"},
        },
        "ARM": {
            "title": "Armenia",
            "alternative_codes": ["AM", "051"],
            "info": {"official name": "Republic of Armenia"},
        },
        ...
        "AUT": {
            ...
            "info": {"official name": "Republic of Austria"},
        },
        "AZE": {
            "title": "Azerbaijan",
            "alternative_codes": ["AZ", "031"],
            "info": {"official name": "Republic of Azerbaijan"},
        },
        "BDI": {
            "title": "Burundi",
            "alternative_codes": ["BI", "108"],
            "info": {"official name": "Republic of Burundi"},
        },
        "BEL": {
            "title": "Belgium",
            "alternative_codes": ["BE", "056"],
            "info": {"official name": "Kingdom of Belgium"},
        },
        "BEN": {
            "title": "Benin",
            "alternative_codes": ["BJ", "204"],
            "info": {"official name": "Republic of Benin"},
        },
        "BES": {
            "title": "Bonaire, Sint Eustatius and Saba",
            "alternative_codes": ["BQ", "535"],
            "info": {"official name": "Bonaire, Sint Eustatius and Saba"},
        },
        "BFA": {"title": "Burkina Faso", "alternative_codes": ["BF", "854"]},
        "BGD": {
            "title": "Bangladesh",
            "alternative_codes": ["BD", "050"],
            "info": {"official name": "People's Republic of Bangladesh"},
        },
        "BGR": {
            "title": "Bulgaria",
            "alternative_codes": ["BG", "100"],
            "info": {"official name": "Republic of Bulgaria"},
        },
        "BHR": {
            "title": "Bahrain",
            "alternative_codes": ["BH", "048"],
            "info": {"official name": "Kingdom of Bahrain"},
        },
        "BHS": {
            "title": "Bahamas",
            "alternative_codes": ["BS", "044"],
            "info": {"official name": "Commonwealth of the Bahamas"},
        },
        "BIH": {
            "title": "Bosnia and Herzegovina",
            "alternative_codes": ["BA", "070"],
            "info": {"official name": "Republic of Bosnia and Herzegovina"},
        },
        "BLM": {"title": "Saint Barthélemy", "alternative_codes": ["BL", "652"]},
        "BLR": {
            "title": "Belarus",
            "alternative_codes": ["BY", "112"],
            "info": {"official name": "Republic of Belarus"},
        },
        ...
        "BRA": {
            ...
            "info": {"official name": "Federative Republic of Brazil"},
        },
        ...
        "BTN": {
            ...
            "info": {"official name": "Kingdom of Bhutan"},
        },
        "BVT": {"title": "Bouvet Island", "alternative_codes": ["BV", "074"]},
        "BWA": {
            "title": "Botswana",
            "alternative_codes": ["BW", "072"],
            "info": {"official name": "Republic of Botswana"},
        },
        "CAF": {
        ...
        "CHE": {
            ...
            "info": {"official name": "Swiss Confederation"},
        },
        "CHL": {
            "title": "Chile",
            "alternative_codes": ["CL", "152"],
            "info": {"official name": "Republic of Chile"},
        },
        "CHN": {
            "title": "China",
            "alternative_codes": ["CN", "156"],
            "info": {"official name": "People's Republic of China"},
        },
        "CIV": {
            "title": "Côte d'Ivoire",
            "alternative_codes": ["CI", "384"],
            "info": {"official name": "Republic of Côte d'Ivoire"},
        },
        "CMR": {
            "title": "Cameroon",
            "alternative_codes": ["CM", "120"],
            "info": {"official name": "Republic of Cameroon"},
        },
        "COD": {
        ...
        "COG": {
            ...
            "info": {"official name": "Republic of the Congo"},
        },
        "COK": {"title": "Cook Islands", "alternative_codes": ["CK", "184"]},
        "COL": {
            "title": "Colombia",
            "alternative_codes": ["CO", "170"],
            "info": {"official name": "Republic of Colombia"},
        },
        "COM": {
            "title": "Comoros",
            "alternative_codes": ["KM", "174"],
            "info": {"official name": "Union of the Comoros"},
        },
        "CPV": {
            "title": "Cabo Verde",
            "alternative_codes": ["CV", "132"],
            "info": {"official name": "Republic of Cabo Verde"},
        },
        "CRI": {
            "title": "Costa Rica",
            "alternative_codes": ["CR", "188"],
            "info": {"official name": "Republic of Costa Rica"},
        },
        "CUB": {
            "title": "Cuba",
            "alternative_codes": ["CU", "192"],
            "info": {"official name": "Republic of Cuba"},
        },
        "CUW": {
            "title": "Curaçao",
            "alternative_codes": ["CW", "531"],
            "info": {"official name": "Curaçao"},
        },
        ...
        "CYP": {
            ...
            "info": {"official name": "Republic of Cyprus"},
        },
        "CZE": {
            "title": "Czechia",
            "alternative_codes": ["CZ", "203"],
            "info": {"official name": "Czech Republic"},
        },
        "DEU": {
            "title": "Germany",
            "alternative_codes": ["DE", "276"],
            "info": {"official name": "Federal Republic of Germany"},
        },
        "DJI": {
            "title": "Djibouti",
            "alternative_codes": ["DJ", "262"],
            "info": {"official name": "Republic of Djibouti"},
        },
        "DMA": {
            "title": "Dominica",
            "alternative_codes": ["DM", "212"],
            "info": {"official name": "Commonwealth of Dominica"},
        },
        "DNK": {
            "title": "Denmark",
            "alternative_codes": ["DK", "208"],
            "info": {"official name": "Kingdom of Denmark"},
        },
        "DOM": {"title": "Dominican Republic", "alternative_codes": ["DO", "214"]},
        "DZA": {
            "title": "Algeria",
            "alternative_codes": ["DZ", "012"],
            "info": {"official name": "People's Democratic Republic of Algeria"},
        },
        "ECU": {
            "title": "Ecuador",
            "alternative_codes": ["EC", "218"],
            "info": {"official name": "Republic of Ecuador"},
        },
        "EGY": {
            "title": "Egypt",
            "alternative_codes": ["EG", "818"],
            "info": {"official name": "Arab Republic of Egypt"},
        },
        "ERI": {
            "title": "Eritrea",
            "alternative_codes": ["ER", "232"],
            "info": {"official name": "the State of Eritrea"},
        },
        "ESH": {"title": "Western Sahara", "alternative_codes": ["EH", "732"]},
        "ESP": {
            "title": "Spain",
            "alternative_codes": ["ES", "724"],
            "info": {"official name": "Kingdom of Spain"},
        },
        "EST": {
            "title": "Estonia",
            "alternative_codes": ["EE", "233"],
            "info": {"official name": "Republic of Estonia"},
        },
        "ETH": {
            "title": "Ethiopia",
            "alternative_codes": ["ET", "231"],
            "info": {"official name": "Federal Democratic Republic of Ethiopia"},
        },
        "FIN": {
            "title": "Finland",
            "alternative_codes": ["FI", "246"],
            "info": {"official name": "Republic of Finland"},
        },
        "FJI": {
            "title": "Fiji",
            "alternative_codes": ["FJ", "242"],
            "info": {"official name": "Republic of Fiji"},
        },
        "FLK": {
        ...
        "FRA": {
            ...
            "info": {"official name": "French Republic"},
        },
        ...
        "GAB": {
            ...
            "info": {"official name": "Gabonese Republic"},
        },
        "GBR": {
        ...
        "GHA": {
            ...
            "info": {"official name": "Republic of Ghana"},
        },
        "GIB": {"title": "Gibraltar", "alternative_codes": ["GI", "292"]},
        "GIN": {
            "title": "Guinea",
            "alternative_codes": ["GN", "324"],
            "info": {"official name": "Republic of Guinea"},
        },
        "GLP": {"title": "Guadeloupe", "alternative_codes": ["GP", "312"]},
        "GMB": {
            "title": "Gambia",
            "alternative_codes": ["GM", "270"],
            "info": {"official name": "Republic of the Gambia"},
        },
        "GNB": {
            "title": "Guinea-Bissau",
            "alternative_codes": ["GW", "624"],
            "info": {"official name": "Republic of Guinea-Bissau"},
        },
        "GNQ": {
            "title": "Equatorial Guinea",
            "alternative_codes": ["GQ", "226"],
            "info": {"official name": "Republic of Equatorial Guinea"},
        },
        "GRC": {
            "title": "Greece",
            "alternative_codes": ["GR", "300"],
            "info": {"official name": "Hellenic Republic"},
        },
        ...
        "GTM": {
            ...
            "info": {"official name": "Republic of Guatemala"},
        },
        ...
        "GUY": {
            ...
            "info": {"official name": "Republic of Guyana"},
        },
        "HKG": {
            "title": "Hong Kong",
        ...
        "HND": {
            ...
            "info": {"official name": "Republic of Honduras"},
        },
        "HRV": {
            "title": "Croatia",
            "alternative_codes": ["HR", "191"],
            "info": {"official name": "Republic of Croatia"},
        },
        "HTI": {
            "title": "Haiti",
            "alternative_codes": ["HT", "332"],
            "info": {"official name": "Republic of Haiti"},
        },
        "HUN": {
            "title": "Hungary",
            "alternative_codes": ["HU", "348"],
            "info": {"official name": "Hungary"},
        },
        "IDN": {
            "title": "Indonesia",
            "alternative_codes": ["ID", "360"],
            "info": {"official name": "Republic of Indonesia"},
        },
        "IMN": {"title": "Isle of Man", "alternative_codes": ["IM", "833"]},
        "IND": {
            "title": "India",
            "alternative_codes": ["IN", "356"],
            "info": {"official name": "Republic of India"},
        },
        "IOT": {
        ...
        "IRQ": {
            ...
            "info": {"official name": "Republic of Iraq"},
        },
        "ISL": {
            "title": "Iceland",
            "alternative_codes": ["IS", "352"],
            "info": {"official name": "Republic of Iceland"},
        },
        "ISR": {
            "title": "Israel",
            "alternative_codes": ["IL", "376"],
            "info": {"official name": "State of Israel"},
        },
        "ITA": {
            "title": "Italy",
            "alternative_codes": ["IT", "380"],
            "info": {"official name": "Italian Republic"},
        },
        ...
        "JOR": {
            ...
            "info": {"official name": "Hashemite Kingdom of Jordan"},
        },
        "JPN": {"title": "Japan", "alternative_codes": ["JP", "392"]},
        "KAZ": {
            "title": "Kazakhstan",
            "alternative_codes": ["KZ", "398"],
            "info": {"official name": "Republic of Kazakhstan"},
        },
        "KEN": {
            "title": "Kenya",
            "alternative_codes": ["KE", "404"],
            "info": {"official name": "Republic of Kenya"},
        },
        "KGZ": {
            "title": "Kyrgyzstan",
            "alternative_codes": ["KG", "417"],
            "info": {"official name": "Kyrgyz Republic"},
        },
        "KHM": {
            "title": "Cambodia",
            "alternative_codes": ["KH", "116"],
            "info": {"official name": "Kingdom of Cambodia"},
        },
        "KIR": {
            "title": "Kiribati",
        ...
        "KWT": {
            ...
            "info": {"official name": "State of Kuwait"},
        },
        "LAO": {
        ...
        "LBN": {
            ...
            "info": {"official name": "Lebanese Republic"},
        },
        "LBR": {
            "title": "Liberia",
            "alternative_codes": ["LR", "430"],
            "info": {"official name": "Republic of Liberia"},
        },
        "LBY": {
            "title": "Libya",
            "alternative_codes": ["LY", "434"],
            "info": {"official name": "Libya"},
        },
        "LCA": {"title": "Saint Lucia", "alternative_codes": ["LC", "662"]},
        "LIE": {
            "title": "Liechtenstein",
            "alternative_codes": ["LI", "438"],
            "info": {"official name": "Principality of Liechtenstein"},
        },
        "LKA": {
            "title": "Sri Lanka",
            "alternative_codes": ["LK", "144"],
            "info": {"official name": "Democratic Socialist Republic of Sri Lanka"},
        },
        "LSO": {
            "title": "Lesotho",
            "alternative_codes": ["LS", "426"],
            "info": {"official name": "Kingdom of Lesotho"},
        },
        "LTU": {
            "title": "Lithuania",
            "alternative_codes": ["LT", "440"],
            "info": {"official name": "Republic of Lithuania"},
        },
        "LUX": {
            "title": "Luxembourg",
            "alternative_codes": ["LU", "442"],
            "info": {"official name": "Grand Duchy of Luxembourg"},
        },
        "LVA": {
            "title": "Latvia",
            "alternative_codes": ["LV", "428"],
            "info": {"official name": "Republic of Latvia"},
        },
        "MAC": {
            "title": "Macao",
            "alternative_codes": ["MO", "446"],
            "info": {"official name": "Macao Special Administrative Region of China"},
        },
        "MAF": {
        ...
        "MAR": {
            ...
            "info": {"official name": "Kingdom of Morocco"},
        },
        "MCO": {
            "title": "Monaco",
            "alternative_codes": ["MC", "492"],
            "info": {"official name": "Principality of Monaco"},
        },
        "MDA": {
        ...
        "MDG": {
            ...
            "info": {"official name": "Republic of Madagascar"},
        },
        "MDV": {
            "title": "Maldives",
            "alternative_codes": ["MV", "462"],
            "info": {"official name": "Republic of Maldives"},
        },
        "MEX": {
            "title": "Mexico",
            "alternative_codes": ["MX", "484"],
            "info": {"official name": "United Mexican States"},
        },
        "MHL": {
            "title": "Marshall Islands",
            "alternative_codes": ["MH", "584"],
            "info": {"official name": "Republic of the Marshall Islands"},
        },
        "MKD": {
            "title": "North Macedonia",
            "alternative_codes": ["MK", "807"],
            "info": {"official name": "Republic of North Macedonia"},
        },
        "MLI": {
            "title": "Mali",
            "alternative_codes": ["ML", "466"],
            "info": {"official name": "Republic of Mali"},
        },
        "MLT": {
            "title": "Malta",
            "alternative_codes": ["MT", "470"],
            "info": {"official name": "Republic of Malta"},
        },
        "MMR": {
            "title": "Myanmar",
            "alternative_codes": ["MM", "104"],
            "info": {"official name": "Republic of Myanmar"},
        },
        "MNE": {
            "title": "Montenegro",
            "alternative_codes": ["ME", "499"],
            "info": {"official name": "Montenegro"},
        },
        "MNG": {"title": "Mongolia", "alternative_codes": ["MN", "496"]},
        "MNP": {
            "title": "Northern Mariana Islands",
            "alternative_codes": ["MP", "580"],
            "info": {"official name": "Commonwealth of the Northern Mariana Islands"},
        },
        "MOZ": {
            "title": "Mozambique",
            "alternative_codes": ["MZ", "508"],
            "info": {"official name": "Republic of Mozambique"},
        },
        "MRT": {
            "title": "Mauritania",
            "alternative_codes": ["MR", "478"],
            "info": {"official name": "Islamic Republic of Mauritania"},
        },
        ...
        "MUS": {
            ...
            "info": {"official name": "Republic of Mauritius"},
        },
        "MWI": {
            "title": "Malawi",
            "alternative_codes": ["MW", "454"],
            "info": {"official name": "Republic of Malawi"},
        },
        ...
        "NAM": {
            ...
            "info": {"official name": "Republic of Namibia"},
        },
        "NCL": {"title": "New Caledonia", "alternative_codes": ["NC", "540"]},
        "NER": {
            "title": "Niger",
            "alternative_codes": ["NE", "562"],
            "info": {"official name": "Republic of the Niger"},
        },
        "NFK": {"title": "Norfolk Island", "alternative_codes": ["NF", "574"]},
        "NGA": {
            "title": "Nigeria",
            "alternative_codes": ["NG", "566"],
            "info": {"official name": "Federal Republic of Nigeria"},
        },
        "NIC": {
            "title": "Nicaragua",
            "alternative_codes": ["NI", "558"],
            "info": {"official name": "Republic of Nicaragua"},
        },
        "NIU": {
            "title": "Niue",
            "alternative_codes": ["NU", "570"],
            "info": {"official name": "Niue"},
        },
        "NLD": {
            "title": "Netherlands",
            "alternative_codes": ["NL", "528"],
            "info": {"official name": "Kingdom of the Netherlands"},
        },
        "NOR": {
            "title": "Norway",
            "alternative_codes": ["NO", "578"],
            "info": {"official name": "Kingdom of Norway"},
        },
        "NPL": {
            "title": "Nepal",
            "alternative_codes": ["NP", "524"],
            "info": {"official name": "Federal Democratic Republic of Nepal"},
        },
        "NRU": {
            "title": "Nauru",
            "alternative_codes": ["NR", "520"],
            "info": {"official name": "Republic of Nauru"},
        },
        "NZL": {"title": "New Zealand", "alternative_codes": ["NZ", "554"]},
        "OMN": {
            "title": "Oman",
            "alternative_codes": ["OM", "512"],
            "info": {"official name": "Sultanate of Oman"},
        },
        "PAK": {
            "title": "Pakistan",
            "alternative_codes": ["PK", "586"],
            "info": {"official name": "Islamic Republic of Pakistan"},
        },
        "PAN": {
            "title": "Panama",
            "alternative_codes": ["PA", "591"],
            "info": {"official name": "Republic of Panama"},
        },
        "PCN": {"title": "Pitcairn", "alternative_codes": ["PN", "612"]},
        "PER": {
            "title": "Peru",
            "alternative_codes": ["PE", "604"],
            "info": {"official name": "Republic of Peru"},
        },
        "PHL": {
            "title": "Philippines",
            "alternative_codes": ["PH", "608"],
            "info": {"official name": "Republic of the Philippines"},
        },
        "PLW": {
            "title": "Palau",
            "alternative_codes": ["PW", "585"],
            "info": {"official name": "Republic of Palau"},
        },
        "PNG": {
            "title": "Papua New Guinea",
            "alternative_codes": ["PG", "598"],
            "info": {"official name": "Independent State of Papua New Guinea"},
        },
        "POL": {
            "title": "Poland",
            "alternative_codes": ["PL", "616"],
            "info": {"official name": "Republic of Poland"},
        },
        ...
        "PRT": {
            ...
            "info": {"official name": "Portuguese Republic"},
        },
        "PRY": {
            "title": "Paraguay",
            "alternative_codes": ["PY", "600"],
            "info": {"official name": "Republic of Paraguay"},
        },
        "PSE": {
        ...
        "QAT": {
            ...
            "info": {"official name": "State of Qatar"},
        },
        ...
        "RWA": {
            ...
            "info": {"official name": "Rwandese Republic"},
        },
        "SAU": {
            "title": "Saudi Arabia",
            "alternative_codes": ["SA", "682"],
            "info": {"official name": "Kingdom of Saudi Arabia"},
        },
        "SDN": {
            "title": "Sudan",
            "alternative_codes": ["SD", "729"],
            "info": {"official name": "Republic of the Sudan"},
        },
        "SEN": {
            "title": "Senegal",
            "alternative_codes": ["SN", "686"],
            "info": {"official name": "Republic of Senegal"},
        },
        "SGP": {
            "title": "Singapore",
            "alternative_codes": ["SG", "702"],
            "info": {"official name": "Republic of Singapore"},
        },
        "SGS": {
        ...
        "SLE": {
            ...
            "info": {"official name": "Republic of Sierra Leone"},
        },
        "SLV": {
            "title": "El Salvador",
            "alternative_codes": ["SV", "222"],
            "info": {"official name": "Republic of El Salvador"},
        },
        "SMR": {
            "title": "San Marino",
            "alternative_codes": ["SM", "674"],
            "info": {"official name": "Republic of San Marino"},
        },
        "SOM": {
            "title": "Somalia",
            "alternative_codes": ["SO", "706"],
            "info": {"official name": "Federal Republic of Somalia"},
        },
        "SPM": {
        ...
        "SRB": {
            ...
            "info": {"official name": "Republic of Serbia"},
        },
        "SSD": {
            "title": "South Sudan",
            "alternative_codes": ["SS", "728"],
            "info": {"official name": "Republic of South Sudan"},
        },
        "STP": {
            "title": "Sao Tome and Principe",
            "alternative_codes": ["ST", "678"],
            "info": {"official name": "Democratic Republic of Sao Tome and Principe"},
        },
        "SUR": {
            "title": "Suriname",
            "alternative_codes": ["SR", "740"],
            "info": {"official name": "Republic of Suriname"},
        },
        "SVK": {
            "title": "Slovakia",
            "alternative_codes": ["SK", "703"],
            "info": {"official name": "Slovak Republic"},
        },
        "SVN": {
            "title": "Slovenia",
            "alternative_codes": ["SI", "705"],
            "info": {"official name": "Republic of Slovenia"},
        },
        "SWE": {
            "title": "Sweden",
            "alternative_codes": ["SE", "752"],
            "info": {"official name": "Kingdom of Sweden"},
        },
        "SWZ": {
            "title": "Eswatini",
            "alternative_codes": ["SZ", "748"],
            "info": {"official name": "Kingdom of Eswatini"},
        },
        "SXM": {
            "title": "Sint Maarten (Dutch part)",
            "alternative_codes": ["SX", "534"],
            "info": {"official name": "Sint Maarten (Dutch part)"},
        },
        "SYC": {
            "title": "Seychelles",
        ...
        "TCD": {
            ...
            "info": {"official name": "Republic of Chad"},
        },
        "TGO": {
            "title": "Togo",
            "alternative_codes": ["TG", "768"],
            "info": {"official name": "Togolese Republic"},
        },
        "THA": {
            "title": "Thailand",
            "alternative_codes": ["TH", "764"],
            "info": {"official name": "Kingdom of Thailand"},
        },
        "TJK": {
            "title": "Tajikistan",
            "alternative_codes": ["TJ", "762"],
            "info": {"official name": "Republic of Tajikistan"},
        },
        ...
        "TLS": {
            ...
            "info": {"official name": "Democratic Republic of Timor-Leste"},
        },
        "TON": {
            "title": "Tonga",
            "alternative_codes": ["TO", "776"],
            "info": {"official name": "Kingdom of Tonga"},
        },
        "TTO": {
            "title": "Trinidad and Tobago",
            "alternative_codes": ["TT", "780"],
            "info": {"official name": "Republic of Trinidad and Tobago"},
        },
        "TUN": {
            "title": "Tunisia",
            "alternative_codes": ["TN", "788"],
            "info": {"official name": "Republic of Tunisia"},
        },
        "TUR": {
            "title": "Türkiye",
            "alternative_codes": ["TR", "792"],
            "info": {"official name": "Republic of Türkiye"},
        },
        ...
        "UGA": {
            ...
            "info": {"official name": "Republic of Uganda"},
        },
        ...
        "URY": {
            ...
            "info": {"official name": "Eastern Republic of Uruguay"},
        },
        "USA": {
            "title": "United States",
            "alternative_codes": ["US", "840"],
            "info": {"official name": "United States of America"},
        },
        "UZB": {
            "title": "Uzbekistan",
            "alternative_codes": ["UZ", "860"],
            "info": {"official name": "Republic of Uzbekistan"},
        },
        "VAT": {
        ...
        "VGB": {
            ...
            "info": {"official name": "British Virgin Islands"},
        },
        "VIR": {
            "title": "Virgin Islands, U.S.",
            "alternative_codes": ["VI", "850"],
            "info": {"official name": "Virgin Islands of the United States"},
        },
        "VNM": {
            "title": "Viet Nam",
        ...
        "VUT": {
            ...
            "info": {"official name": "Republic of Vanuatu"},
        },
        "WLF": {"title": "Wallis and Futuna", "alternative_codes": ["WF", "876"]},
        "WSM": {
            "title": "Samoa",
            "alternative_codes": ["WS", "882"],
            "info": {"official name": "Independent State of Samoa"},
        },
        "YEM": {
            "title": "Yemen",
            "alternative_codes": ["YE", "887"],
            "info": {"official name": "Republic of Yemen"},
        },
        "ZAF": {
            "title": "South Africa",
            "alternative_codes": ["ZA", "710"],
            "info": {"official name": "Republic of South Africa"},
        },
        "ZMB": {
            "title": "Zambia",
            "alternative_codes": ["ZM", "894"],
            "info": {"official name": "Republic of Zambia"},
        },
        "ZWE": {
            "title": "Zimbabwe",
            "alternative_codes": ["ZW", "716"],
            "info": {"official name": "Republic of Zimbabwe"},
        },
        "World": {
            "title": "The world",
